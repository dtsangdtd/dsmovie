  ...
  const renderLogin = () => {
    if (taiKhoan) {
      return (
        <Fragment>
          ...
          >
            <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRhaoenSOpLdyff66kLuweUoEFOE_DMmdBRFQ&usqp=CAU" alt="user" />
    ...
    return (
      <NavLink className="login__link" to="/login">
        <img src="https://cdn.onlinewebfonts.com/svg/img_388254.png" alt="user" />
